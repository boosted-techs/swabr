...
<html>
    ...
    <body>
        <p>Hi <?=$this->input->post('title')." ".$this->input->post('firstName')?>,<br>
            Welcome to  Stock Manager. Find below your registration details and please do not hesitate to inform us if there is any
            mistake. Thanks.
        </p>
        ...
        <p><small>The Manager, <br>RazerTech Stock Manager</small></p>
    </body>
</html>
